...
exports.dealSuccessCommon = function(message,time) {
    var dlg = BootstrapDialog.show({
        ...
        buttons: [{
            label: '<i class= "fa fa-fw fa-close"></i>关闭 (<span class="second">2</span>)',
            cssClass: 'btn-info ',
            action: function(dialogItself) {
                dialogItself.close()
            }
...
exports.initSelect2Wrap= function(jqItem, sdata) {
    jqItem.select2({
        maximumSelectionLength: 1,
        language: 'zh-CN',
        tags: false,
        ...
        data: sdata,
        multiple: true,
        containerCssClass:'select2-wrap'
    })
}
...
exports.initDateTimespicker = function(jqItem) {
    jqItem.datetimepicker({
        language: 'zh-CN',
        autoclose: true,
        todayHighlight: true,
...
exports.startDatepicker = function(start, end) {
    start.datetimepicker({
        language: 'zh-CN',
        autoclose: true,
        todayHighlight: true,
...
exports.endDatepicker = function(end, start) {
    end.datetimepicker({
        language: 'zh-CN',
        autoclose: true,
        todayHighlight: true,
...
/**
 * @param value 时间
 * @param type 返回的时间格式类型：min (2018-9-20 8:30), month (2018-9)
 * @returns {string}
 */
exports.dateTimeFormat = function (value, type) {
  if (value) {
...
exports.BTRowFormatAlignRight = function(rowid, rowname) {
    return {
        field: rowid,
        title: rowname,
        class: 'text-nowrap',
...
exports.BTRowFormatEditableLeft = function(rowid, rowname, rFormatter) {
    return {
        field: rowid,
        title: rowname,
        formatter: rFormatter,
...
exports.BTRowFormatEditableRight = function(rowid, rowname, rFormatter) {
    return {
        field: rowid,
        title: rowname,
        formatter: rFormatter,
...
exports.BTRowFormatEnumberWAlginRight = function(rowid, rowname, width) {
    return {
        field: rowid,
        title: rowname,
        width: width,
...
exports.BTRowFormatEnumberWMinALginRight = function(rowid, rowname, width) {
    return {
        field: rowid,
        title: rowname,
        width: width,
...
exports.BTRowFormatEdSelectAlignLeft = function(_self, rowid, rowname, paraIndex, width = 200) {
    return {
        field: rowid,
        title: rowname,
        class: 'text-nowrap',
...
exports.BTRowFormatEdSelect2DisabledAlignLeft = function(_self, rowid, rowname, paraIndex, width = 200) {
    return {
        field: rowid,
        title: rowname,
        class: 'text-nowrap',
...
exports.BTRowFormatEdPrice = function(rowid, rowname,rFormatter) {
    return {
        field: rowid,
        title: rowname,
        formatter: rFormatter,
...
exports.BTRowFormatEdTextareaWidthAlignLeft = function(rowid, rowname, witdth, n) {
    return {
        field: rowid,
        title: rowname,
        class: 'auto-line',
...
exports.BTRowFormatEdTextareaWidthAlignLeft2 = function(rowid, rowname, rFormatter , witdth, n) {
    return {
        field: rowid,
        title: rowname,
        class: 'auto-line',
...
exports.BTRowFormatWithFormatter = function(rowid, rowname, rFormatter, events) {
    return {
        field: rowid,
        title: rowname,
        formatter: rFormatter,
...
exports.BTRowFormatWithFormatterAlignRight = function(rowid, rowname, rFormatter) {
    return {
        field: rowid,
        title: rowname,
        formatter: rFormatter,
...
exports.BTRowFormatWithFEL = function(rowid, rowname, rFormatter, e) {
    return {
        field: rowid,
        title: rowname,
        formatter: rFormatter,
...
exports.DynamicEditableByDomain2 = function(value, table) {
    $("[data-uniqueid]").each(function() {
        let actrow = table.bootstrapTable('getRowByUniqueId', this.getAttribute('data-uniqueid'))
        console.log('table:', actrow);
        if (actrow.domain_id) {
            if (actrow.domain_type === value) {
                $(this).find('[data-name]').each(function() {
                    $(this).attr("data-disabled", true)
                })
            }
...
exports.promptInformationCommon = function(obj, response) {
    if (response.status > 699 && response.status < 800) {
        console.log('700 error')
        BootstrapDialog.show({
            title: '<i class= "fa fa-fw fa-info-circle"></i><strong>提示信息</strong>',
...
exports.setTitle = function (company) {
    if(company == 'nca'){
        document.title = "NCA管理系统";
        $('#favicon').attr('href','/static/images/favicon.ico');
        $('#theme').attr('href','/static/dependencies/assets/css/theme/default.css');
    } else if (company == 'erc') {
        document.title = "炭都科技集团管理系统"
        $('#theme').attr('href','/static/css/blue.css');
        $('#favicon').attr('href','/static/images/erc-favicon.ico');
    }
}
...
//格式化金额
exports.priceFormat=function (value, row, index) {
    if (isNaN(value) || value == "") return "";
    value = Math.round(value * 100) / 100;
    if (value < 0)
        return '-' + exports.outputdollars(Math.floor(Math.abs(value) - 0) + '') + exports.outputcents(Math.abs(value) - 0);
    else
        return exports.outputdollars(Math.floor(value - 0) + '') + exports.outputcents(value - 0);
}
