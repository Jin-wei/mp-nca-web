        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">机构模板列表</h4>
                </div>
                <div class="panel-toolbar">
                    <div class="form-inline">
                        <div class="form-group pull-right">
                            <div class="form-group">
                                <button class="btn btn-primary btn-info" v-on:click="addT">增加模板
                              </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form class="form-horizontal" @submit.prevent="submitT" id="formT">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-md-2 control-label"><span class="table-required">*</span>模板名称</label>
                            <div class="col-md-9">
    ...
    function initTable() {
      $templateTable.bootstrapTable({
        ...
        columns: [
          ...
          common.BTRowFormatWithFEL('domaintemplate_name', '模板名称', templateNameFormatter, tableEvents),
