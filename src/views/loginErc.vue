...
<div v-cloak>
    <div class="mainDiv">
        ...
        <!--<img src="/static/images/logo/supplier_login_logo.png" alt="丝路全网信息化管理系统" class="title2">-->
