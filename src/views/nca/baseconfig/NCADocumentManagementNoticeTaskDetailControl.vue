        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <table id="documentDetailNoticeTable"></table>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <table id="documentFilesNoticeTable"></table>
                </div>
            </div>
        </div>
    </div>
...
const apiUrl = '/api/nca/baseconfig/NCADocumentManagementControl?method=';
...
export default {
    ...
    name: 'NCADocumentManagementNoticeTaskDetailControl',
    mounted: function() {
        let _self = this;
        let $documentDetailNoticeTable = $('#documentDetailNoticeTable');
        let $documentFilesNoticeTable = $('#documentFilesNoticeTable');
        ...
        async function initData() {
            ...
            async function getTablesData() {
                try {
                    ...
                    let retdata = response.data.info;
                    $('#documentFilesNoticeTable').bootstrapTable('load', {
        ...
        function initAllDemandTable() {
            window.tableEvents = {
                'click .show_detail': function(e, value, row, index) {
                    _self.$router.push({
                        path: '/nca/baseconfig/NCATestTaskInDetailControl',
                        query: row
                    })
                },
                'click .show_answer': function(e, value, row, index) {
                    _self.$router.push({
                        path: '/nca/baseconfig/NCATestTaskAnswerInDetailControl',
                        query: row
                    })
                }
            };
            ...
            let columsArr = [
                ...
                common.BTRowFormatWithFormatterAlignLeft('clause_no', '条款编号',common.remarkFormatter),
            ...
            $documentDetailNoticeTable.bootstrapTable({
                method: 'POST',
                url: apiUrl + 'search_taskdetail',
            ...
            common.changeTableClass($documentDetailNoticeTable)
        }
        ...
        function initFileTable() {
            ...
            $documentFilesNoticeTable.bootstrapTable('destroy');

            $documentFilesNoticeTable.bootstrapTable({
                columns: columns,
                idField: 'document_id',
            ...
            common.changeTableClass($documentFilesNoticeTable)
        }
