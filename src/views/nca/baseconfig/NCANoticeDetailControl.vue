                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" style="width:100%" id="answer" disabled></select>
                                    <!--<input class="form-control" id="answer" v-model="noticeDetal.notice_answer" data-parsley-required="true" data-parsley-maxlength="20" disabled>-->
                                </div>
                            </div>
                        </div>
                        <div class="row">
...
<script>
  ...
  const apiUrl = '/api/nca/baseconfig/NCANoticeControl?method=';
    ...
    mounted: function() {
      ...
      async function getNotice() {
        try {
          ...
          $('#answer').val(_self.noticeDetal.notice_answer).trigger('change');
        } catch (error) {
          common.dealErrorCommon(_self, error)
        }
      }
        ...
        function initFileTable() {
            let columns;
                columns = [
                    ...
                    common.BTRowFormatAlignLeft('notice_title', '主题'),
