...
<div>
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="javascript: history.back()">供应商管理</a></li>
        <li class="active">供应商团队列表</li>
    </ol>
    <!-- end breadcrumb -->
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">供应商团队列表</h4>
                </div>
                ...
                <div class="panel-body auto-height hidedesk" style="display:none;">
                    <table id="supplierTeamTable"></table>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn btn-info" @click="onAddSupplierUser">保存</button>
                </div>
            </div>
        </div>
    </div>
...
const apiUrl = '/api/nca/baseconfig/NCASupplierControl?method='
...
export default {
    ...
    mounted: function() {
        ...
        this.masterTable = $('#supplierTeamTable')
        this.modal = $('#AddModal')
        this.initPage()
    },
    methods: {
        queryParams: function (params) {
            ...
            params.supplier_id = this.queryData.supplier_id;
        ...
        addSignUser: function() {
            this.$http.post(apiUrl + 'getUserForSupplier', this.workRow).then(response => {
        ...
        initTable: function () {
            window.tableEvents = {
                'click .tableDelete': (e, value, row, index) => {
                    common.rowDeleteWithApi(this, '供应商用户删除', apiUrl + 'removeSignUser', this.masterTable, row, 'thirdsignuser_id')
                }
            };
        ...
        onAddSupplierUser: function () {
            ...
            this.$http.post(apiUrl + 'signUserForSupplier', {
