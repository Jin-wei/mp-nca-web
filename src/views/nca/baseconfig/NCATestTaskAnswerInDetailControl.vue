        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                    <table id="documentAnswerDetailTable"></table>
                </div>
...
export default {
    ...
    name: 'NCATestTaskAnswerInDetailControl',
    mounted: function() {
        let _self = this;
        let $documentAnswerDetailTable = $('#documentAnswerDetailTable');
        ...
        function initAllDemandTable() {
            ...
            $documentAnswerDetailTable.bootstrapTable({
                method: 'POST',
                url: apiUrl + 'search_q',
                ...
                onEditableSave: function(field, row, oldValue, $el) {
                    common.rowModifyWithT(_self, apiUrl + 'modify_q', row, 'docdetailquestion_id', $documentAnswerDetailTable)
                }
            });
            common.changeTableClass($documentAnswerDetailTable)
        }
