...
<script>
    ...
    const apiUrl = '/api/nca/baseconfig/NCAWorkerControl?method=';
            ...
            initTable: function () {
                this.masterTable.bootstrapTable({
                    ...
                    columns: [
                        ...
                        /*common.BTRowFormatEditable('user_remark', '备注'),*/
                        common.BTRowFormatEdTextareaWidthAlignLeft('user_remark', '备注',200,10),
