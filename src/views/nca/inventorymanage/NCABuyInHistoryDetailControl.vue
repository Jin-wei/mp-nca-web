...
<div>
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="javascript:history.back()">采购入库流水</a></li>
        <li class="active">采购入库流水单</li>
    </ol>
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">采购入库流水单</h4>
                </div>
                ...
                <div class="panel-body auto-height hidedesk">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-sm-5 control-label">采购订单号</label>
                                <div class="col-sm-7">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input class="form-control" v-model="orderData.supplier_name" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    name: 'NCABuyInHistoryDetailControl',
    filters: {
        date_format(value) {
    ...
    methods: {
        ...
        initHistoryTable: function() {
            this.masterTable.bootstrapTable({
                method: 'POST',
                url: apiUrl + 'getBuyInOrderHistoryDetail',
        ...
        printInvoice: async function() {
            ...
            try {
                ...
                //     filetype = 'pdf'
                // }
                let response = await _self.$http.post(apiUrl + 'buyInOrderHistoryPrint', {
                    supplier_name: _self.orderData.supplier_name,
