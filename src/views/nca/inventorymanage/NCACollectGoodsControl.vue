...
const apiUrl = '/api/nca/inventorymanage/NCACollectGoodsControl?method=';
        ...
        initTable:function(){
            ...
            window.tableEvents = {
                'click .detail': (e, value, row, index) => {
                    this.$router.push({path: '/nca/inventorymanage/NCACollectGoodsDetailControl', query: row});
                }
            };
