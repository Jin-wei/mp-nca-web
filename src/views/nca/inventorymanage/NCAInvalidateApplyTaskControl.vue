    ...
    <div>
        ...
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">报废申请管理</h4>
            </div>
            ...
            <div class="modal-dialog" style="width: 1100px">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">新增报废物料</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group col-xs-3">
                            <button type="button" class="btn btn-info" v-on:click="addInvalidateApply"><i class="fa fa-fw fa-plus"></i>增加</button>
                        </div>
                        <!--<table id="table"></table>-->
                        <div class="panel-body auto-height">
                            <div class="btn-group col-sm-10" style="margin-bottom: 10px">
...
<script>
    ...
    const apiUrl = '/api/nca/inventorymanage/NCAInvalidateApplyControl?method='
    ...
    export default {
        ...
        name: 'NCAInvalidateApplyControl',
        mounted: function() {
            let _self = this;
            let $mTable = $('#mTable');
            let $table = $('#table');
            ...
            function rFormatter(value, row) {
                return [
                    '<a class="tableDelete btn btn-primary btn-xs m-r-5 delete_template btn-info-delete" title="删除">x</a>'
                ].join('')
            }
            ...
            window.tableEvents = {
                'click .tableDelete': function(e, value, row, index) {
                    rowDelete(_self, '删除', apiUrl, row, 'invalidateapplyorder_id');
                }
            }
            ...
            function initTable() {
                $table.bootstrapTable({
                    ...
                    columns: [{
                        ...
                        common.BTRowFormatWithFEL('item_amount', '安全数量'),
                        common.BTRowFormatAlignLeft('warehouse_name', '仓库名称'),
                        common.BTRowFormatAlignLeft('zone_name', '仓区名称'),
                    ],
                    idField: 'stockmap_id',
