        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">
                    ...
                    <h4 class="panel-title">                    <h4 class="panel-title">销售出库流水单</h4>
                    </h4>
                </div>
                ...
                <div class="panel-body auto-height hidedesk">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-sm-5 control-label">销售订单号</label>
                                <div class="col-sm-7">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="col-sm-5 control-label">客户</label>
                                <div class="col-sm-7">
                                    <input class="form-control" v-model="orderData.name" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="btn-group col-sm-12" style="padding: 10px 0px">
                            <button class="btn btn-info pull-right" @click="printInvoice"><i class="fa fa-print"></i> 打印</button>
                        </div>
                    </div>
                </div>
            </div>
...
const apiUrl = '/api/nca/inventorymanage/NCASaleOutControl?method=';
...
export default {
    ...
    name: 'NCASaleOutHistoryDetailControl',
    filters: {
        date_format(value) {
    ...
    methods: {
        ...
        initHistoryTable: function () {
            this.masterTable.bootstrapTable({
                method: 'POST',
                url: apiUrl + 'getSaleOutOrderHistoryDetail',
        ...
        printInvoice: function () {
            Constant.setData('materielInfo', this.pagePara.materielInfo);
            this.$router.push({path: '/NCASaleOutInvoiceControl', query: this.orderData});
        }
    },
    mounted: function() {
